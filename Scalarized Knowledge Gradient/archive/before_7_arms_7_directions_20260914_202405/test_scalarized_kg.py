...
class ExperimentTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        spec = importlib.util.spec_from_file_location('kg_gravity_runner', HERE/'script_holistic_gravity.py')
    ...
    def test_setup_and_evaluation_match_previous_holistic_gravity(self):
        ...
        b = self.setup['bandit']
        self.assertEqual((b['n_arms'], b['n_scalarization_directions'], b['n_online_iterations']), (10, 5, 150))
        wrong = deepcopy(self.setup)
        wrong['bandit']['n_online_iterations'] = 100
